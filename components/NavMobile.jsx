  ...
  return (
    <div className={`${containerStyles}`}>
      ...
      <aside
        ...
        } bg-navy fixed z-20 w-full p-10 top-0 bottom-0 transition-all duration-500`}
      >
        <div className="flex flex-col items-center justify-between h-full">
          {/* nav close btn */}
          <div
            onClick={() => setIsOpen(false)}
            className="cursor-pointer text-4xl text-white absolute w-10 h-10 left-8 top-8 bg-navy flex items-center justify-center"
          >
            <IoCloseOutline />
          </div>
          {/* logo */}
